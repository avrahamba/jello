                        ...
                        <div>
                            <div class="edit-cover-container">
                                ...
                                <template v-if="isCoverMode">
                                    ...
                                    <cover-picker @input="save" v-model="taskToSave.cover" :covers="taskToSave.attachments"></cover-picker>
                                </template>
                            </div>
                        </div>
                        <div class="remove">
    ...
    methods: {
        ...
        startRemoveTask() {
            Swal.fire({
                ...
                if (result.value) {
                    this.$store.dispatch({ type: 'removeTask', taskId: this.taskToSave.id })
                        .then(() => {
                            this.$router.push('/' + this.boardId)
                            Swal.fire(
                                'Deleted!',

                ...
                <div class="modal" v-if="currTask">
                    ...
                    <div class="title-area">
                        <div class="icon-container">
                            ...
                            <input class="task-title" type="textarea" @blur="setTitle" @keydown="keydownTitle" placeholder="Title" v-model="taskToSave.title" />
                        </div>
                    ...
                    <div class="detail-area">
                        ...
                        <div class="description-container">
                            ...
                            <div class="desc-container" v-if="editDesc">
                                <textarea-autosize ref="descriptionTextarea" placeholder="Add a more detailed description…" v-model="taskToSave.desc" @blur.native="saveDesc" cols="65" rows="3" class="description-tesxtarea" />
                    ...
                    <div class="add-area">
                        ...
                        <add-member-to-task :style="miniModalPosition" v-if="addMemberMode" v-model="taskToSave.members" :board="board" @input="save('addMember',{users: taskToSave.members})"></add-member-to-task>
                        <div class="edit-labels-container">
                            ...
                            <template v-if="addLabelMode">
                                ...
                                <label-picker :style="miniModalPosition" @input="save('setLabel',{labels: taskToSave.labels})" v-model="taskToSave.labels"></label-picker>
                            </template>
                        </div>
                        <div class="add-chacklist-container">
                            ...
                            <template v-if="addCheckListMode">
                                ...
                                <add-checklist :style="miniModalPosition" @close="addCheckListMode = false" @add="addChecklist"></add-checklist>
                            </template>
                        </div>
                        <div>
                        ...
                        <template v-if="addDateMode">
                            ...
                            <date-picker :style="miniModalPosition" v-if="addDateMode" v-model="taskToSave.dueDate" @input="save('setDueDate',{dueDate: taskToSave.dueDate})"></date-picker>
                        </template>
                        <div>
                            <button @click="openFile">
                                <i class="fas fa-file-image"></i>
                                <input type="file" @change="uploadImg" ref="fileInput" accept="image/*" multiple hidden />
                                Attachment
                            </button>
                        </div>
                        <div>
                            <div class="edit-cover-container">
                                ...
                                <template v-if="isCoverMode">
                                    ...
                                    <cover-picker class="cover-picker" :style="miniModalPosition" @input="save('setCover',{cover: {url:taskToSave.cover.url}})" v-model="taskToSave.cover" :covers="taskToSave.attachments"></cover-picker>
                                </template>
                            </div>
                        </div>
                        <div class="remove">

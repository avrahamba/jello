            ...
            <div class="overlay" @click.self="closeModal">
                <div class="modal" v-if="currTask">
                    ...
                    <div class="title-area">
                        <input class="task-title" type="text" @blur="setTitle" @keydown="keydownTitle" placeholder="Title" v-model="taskToSave.title" />
                        <br />in list
                        <a href="#">{{listName}}</a>
                    </div>
                    <div class="detail-area">
                        <div class="date-area" v-if="currTask">
                            <date-picker v-if="currTask.dueDate.length||addDateMode" v-model="taskToSave.dueDate" @input="save('setDueDate',{dueDate: taskToSave.dueDate})"></date-picker>
                        </div>
                        ...
                        <file-picker v-model="taskToSave.attachments" @input="save('attachments',{attachments: taskToSave.attachments})"></file-picker>
                    ...
                    <div class="add-area">
                        ...
                        <div class="edit-labels-container">
                            ...
                            <template v-if="addLabelMode">
                                ...
                                <label-picker @input="save('setLabel',{labels: taskToSave.labels})" v-model="taskToSave.labels"></label-picker>
                            </template>
                        </div>
                        ...
                        <div>
                            <div class="edit-cover-container">
                                ...
                                <template v-if="isCoverMode">
                                    ...
                                    <cover-picker @input="save('setLabel',{labels: taskToSave.labels})" v-model="taskToSave.cover" :covers="taskToSave.attachments"></cover-picker>
                                </template>
                            </div>
                        </div>
                        <div class="remove">
...
export default {
    ...
    methods: {
        ...
        setTitle() {
            if (this.currTask.title) this.save('setTitle', { title: this.taskToSave.title });
        },
        startEditDesc() {
            this.editDesc = true;
            setTimeout(() => {
